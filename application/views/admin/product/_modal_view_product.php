    ...
    <div class="row">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="product-barcode">
                        <img src="<?php echo base_url() . $product->barcode ?>" class="img-responsive"/>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-8">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td colspan="2"><a href="<?php echo base_url().'admin/product/view_product_bom/'.$product->product_id ?>"><button type="button" class="btn btn-success btn-block" >Bill Of Materials</button></a></td>
                </tr>
