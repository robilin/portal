                ...
                <div class="box-body">
                    ...
                    <table id="datatable" class="table table-striped table-bordered datatable-buttons">
                            ...
                            <tr>
                                ...
                                <th class="active">Buying price</th>
                            ...
                            <?php if (!empty($damage_product)): foreach ($damage_product as $v_damage_product) : ?>
                                <tr class="custom-tr">
                                    ...
                                    <td class="vertical-td currency"><?php echo $v_damage_product->unit_measure ?></td>
                                    <td class="vertical-td currency"><?php echo $v_damage_product->unit_measure ?></td>
                                    <td class="vertical-td currency"><?php echo $v_damage_product->qty*$v_damage_product->buying_price ?></td>
