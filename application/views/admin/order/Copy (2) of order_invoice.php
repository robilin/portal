    ...
    <div class="row">
        <div class="col-xs-12">
    		...
    		<div class="col-md-10 col-md-offset-5">
    			...
    			<h3 class="pull-right">Invoice # <?php echo $invoice_info->invoice_no ?></h3>
    		</div>
    		<br>
    		<br>
    		<address>
    		<center><strong><?php echo $this->localization->profile('company_name') ?></strong>&&nbsp;&nbsp;nbsp;<?php echo $this->localization->profile('address') ?></center>
    		</address>
    		<hr>
    		<div class="row">
    			<div class="col-xs-6">
