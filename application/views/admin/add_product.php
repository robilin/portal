                                ...
                                <div class="tab-pane" id="bom">
                                    ...
                                    <div class="box">
                                     <div class="box-body">
                                      ...
                                      <div class="table">
                                                <table class="table" id="bomFields">
                                                    <thead>
                                                        ...
                                                        <?php if(!empty($attribute)){ ?>
                                                            <?php foreach($attribute as $v_attribute){ ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" name="bom_description[]" placeholder="Label"
                                                                               value="<?php echo $v_attribute->attribute_description ?>" class="form-control selector" autocomplete="off">
                                                                    </td>
                                                                    <td>

                                                                        <input type="text" name="bom_quantity[]" placeholder="Value"
                                                                               value="<?php echo $v_attribute->attribute_quantity ?>" class="form-control">

                                                                    </td>
                                                                    
                                                                    <td>
                                                                        <input type="text" name="bom_price[]" placeholder="Label"
                                                                               value="<?php echo $v_attribute->bom_price ?>" class="form-control selector" autocomplete="off">
                                                                    </td>
                                                                  
                                                                    <td>
                                                                        <?php echo btn_delete('admin/product/delete_attribute/' . $v_attribute->customer_invoice_id); ?>
                                                                    </td>
                                                                    <input type="hidden" name="bom_id[]" value="<?php echo $v_attribute->customer_invoice_id ?>">
                                                                </tr>
                                                            <?php } ?>
                                                        <?php } else { ?>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <input type="text"  name="bom_description[]" placeholder="Description"
                                                                           value="" class="form-control selector" autocomplete="off">
                                                                </td>
                                                                <td>

                                                                    <input type="text" name="bom_quantity[]" placeholder="Quantity"
                                                                           value="" class="form-control">

                                                                </td>
                                                                <td>

                                                                    <input type="text" name="bom_price[]" placeholder="Price"
                                                                           value="" class="form-control">
    ...
    $(document).ready(function() {
        ...
        $(".addBom").click(function() {
            ...
            value="" class="form-control">\
                        ...
                        <td>\
                        <input type="text" name="bom_price[]" placeholder="Value"\
            value="" class="form-control">\
                        </td>\
                        <td><a href="javascript:void(0);" class="remAttribute">Remove</a></td>\
                        <input type="hidden" name="class_routine_details_id[]" value="">\
        ...
        //Remove Attribute Fields
        $("#bomFields").on('click', '.remAttribute', function() {
            $(this).parent().parent().remove();
        });
