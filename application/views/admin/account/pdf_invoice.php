...
<table style="padding:20px" width="100%">
    ...
    <?php foreach($invoice_details as $v_order): ?>
     <?php 
          $item_name=$this->db->get_where('tbl_laboratory_lab',array('laboratory_lab_id'=>$v_order->attribute_description))->result();
          foreach ($item_name as $value) {
                 echo $value->laboratory_name;
                 $sum+=$value->price; 
           }  
    ...
    <tr align="center">
        ...
        <td style="border-bottom:1px solid #ededed; text-align:right; width: 100px">
            <?php $item_name=$this->db->get_where('tbl_laboratory_lab',array('laboratory_lab_id'=>$v_order->attribute_description))->result();
          foreach ($item_name as $value) {
                 echo $value->laboratory_name;
                 $sum+=$value->price; 
           }   ?>
        ...
        <td style="border-bottom:1px solid #ededed; text-align:right; width: 150px">
            <?php echo $this->localization->currency($sum)  ?>
        </td>
    </tr>
    ...
    <tr align="center">
        ...
        <th style="background:#efeded; text-align: right" ><?php echo $this->localization->currency($sum) ?></th>
    </tr>
    <?php 
    ...
    <tr align="center">
        ...
        <th style="background:#efeded; text-align: right"><?php echo $this->localization->currencyFormat($sum) ?></th>
    </tr>
