            ...
            <div class="box box-primary ">
                ...
                <div class="box-body">
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered datatable-buttons">
                            ...
                            <tr>
                                <th class="active">#</th>
                                <th class="active" width="15%">Message From</th>
                                <th class="active">Message</th>
                                <th class="active">Timestamp</th>
                                <th class="active">View</th>
 								<th class="active">Delete</th>
 								<th class="active">Reply</th>
                            </tr>
                            </thead><!-- / Table head -->
                            <tbody><!-- / Table body -->
                            <?php 
                            
                            $customer_info=$this->db->get('tbl_smpp_hits')->result();
                   ...
                   <?php $counter =1 ; ?>
                            <?php if (!empty($customer_info)): foreach ($customer_info as $v_customer) : ?>
                                <tr class="custom-tr">
                                    ...
                                    <td class="vertical-td"><?php echo '255'.substr($v_customer->from_msisdn, -9); ?></td>
                                    <td class="vertical-td"><?php echo $v_customer->message ?></td> 
                                    <td class="vertical-td"><?php echo $v_customer->sent_timestamp ?></td>
                                        <td class="vertical-td">
                                        <div class="btn-group">
                                        <a href="<?php echo base_url() ?>admin/apis/view_customer_profile_received_items/<?php echo '255'.substr($v_customer->from_msisdn , -9); ?>" class="btn btn-xs bg-orange" > History</a>     
                                    ...
                                    <td class="vertical-td">
 									...
 									<td class="vertical-td"><a href="<?php echo base_url(); ?>admin/apis/send_sms/<?php echo '255'.substr($v_customer->from_msisdn , -9); ?>"class="btn btn-xs btn-success"><i class="fa fa-envelope"> Reply</i></a>                                               </td>
                                </tr>
                            <?php
                                $counter++;
                            endforeach;
