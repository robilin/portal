...
class Customer extends Admin_Controller
{
    ...
    public function save_borrowers_group($id = null)
    {
        ...
        $group_info['group_borrower_ids']=json_encode($group_borrower_ids);
  ...
  /*** Delete Customer ***/
    public function delete_borrowers_group($id=null)
    {
        $this->customer_model->_table_name = 'tbl_loan_groups';
        $this->customer_model->_primary_key = 'loan_group_id';
        $this->customer_model->delete($id);  // delete by id
