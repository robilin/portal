                        ...
                        <div class="col-md-6 border-right">
                            <div class="box-body">                             
                                  <div class="form-group">
                                   <?php $job_title = $this->db->get('tbl_hospital_job_tittle')->result();?>
                                                
                                            <label>Job Title</label>
                                            <select name="job_tittle_id" class="form-control col-sm-5" id="job_title" >
                                                <option value="">Select Title</option>
                                                
                                                <?php if (!empty($job_title)): ?>
                                                    <?php foreach ($job_title as $v_job) : ?>
                                                        <option value="<?php echo $v_job->hospital_job_tittle_id; ?>"
                                                            <?php
                                                            if (!empty($v_job->job_tittle)) {
                                                                echo $v_job->hospital_job_tittle_id == $v_job->hospital_job_tittle_id ? 'selected' : '';
                                                            }
                                                            ?> >
                                                            <?php echo $v_job->job_tittle_name; ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                            </select>
