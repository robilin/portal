		...
		<div class="col-md-12">
			<div class="box box-primary">
			   <div class="box-header box-header-background with-border">
                  <h3 class="box-title ">Attend Patient</h3>
                  <div class="box-tools">
                     <div class="input-group ">
                    <select id="customer" style="width: 100%;" required name="visit_id" onchange="getPatient(this)">
                        ...
                        <?php if (!empty($customer)): ?>
                            <?php foreach ($customer as $item) : ?>
                                <option value="<?php echo $item->customer_visit_id; ?>" <?php echo $this->session->userdata('customer_id') == $item->customer_id ?'selected':'' ?>>
                                    <?php echo $item->customer_visit_id.'-'.$item->customer_name.'Time:'.$item->visit_date_time?>
                                </option>
                            <?php endforeach; ?>
                        <?php endif;?>
                    </select>
			      ...
			      <div class="box-body">
			       <div class="row">
                        <div class="col-md-6 col-md-offset-2">
                            <strong>Patient Code:</strong>  <?php echo $customer_info->customer_code ?>
                        </div>
                             <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-2">
                          <strong>Patient Name:</strong>  <?php echo $customer_info->first_name.' '.$customer_info->second_name.' '.$customer_info->last_name ?>
                        </div>
                        <div class="col-md-4 ">
                            <strong>Age:</strong>  <?php echo $customer_info->age ?>
                        </div>
