                ...
                <div class="box-body">
                    ...
                    <table id="datatable" class="table table-striped table-bordered datatable-buttons">
                            ...
                            <tr>
                                ...
                                <th class="active">LastPayment</th>
                            ...
                            ?>
                            	...
                            	<?php
								$ids= $this->db->get('tbl_loan_repayment')->result();
                                     foreach ($ids as $v_ids) {
                                     $ids=$v_ids->loan_loan_id;
                             }
                             
                              $this->db->select_max('collection_date');
                              $this->db->group_by('loan_loan_id');
							  $result = $this->db->get_where('tbl_loan_repayment',array('loan_loan_id'=>$v_loan->loan_id))->row();
                               
							  

							  if(date('Y-m-d')>=$next_maturity_date && $v_loan->loan_status=='Open' && $v_loan->paid_amount<$v_loan->balance_amount){
                              ...
                              ?>
                                ...
                                $customer = $this->db->get_where('tbl_customer',array('customer_id'=>$v_loan->customer_id))->result();
                                 ...
                                 ?>
                                    ...
                                    if (!empty($result->collection_date)) {
                                    	  echo $result->collection_date;
                                    } else {
                                    	echo 'Never Paid';
                                    }
