                ...
                <main>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td class="desc"><h3><?php echo $v_order->attribute_description ?></h3></td>
                            ...
                            <td class="total"><?php echo $this->localization->currency($v_order->subtotal) ?></td>
                        </tr>
                            <?php $counter ++?>
                        <?php endforeach; ?>
                        </tbody>
                       ...
                       <?php 
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->localization->currencyFormat($total) ?></td>
                        </tr>
