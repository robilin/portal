...
public function __construct()
  ...
  public function add_invoice(){
	...
	public function save_invoice($id=null){
		...
		$visit_data = explode(",", $customer_info); //customer id, visit id
		
        $customer = $this->db->get_where('tbl_customer',array('customer_id'=>$visit_data[0]))->result();
...
//        exit;
        ...
        foreach ($customer as $v_customer){
         ...
         $second_name=$v_customer->second_name;
        ...
        for($i = 0; $i < sizeof($attribute_description);$i++)
        {
            ...
            if($attribute_description[$i] !=null && $attribute_quantity[$i] != null && $attribute_price[$i] != null)
            {
                ...
                $attribute['customer_name'] = $first_name.' '.$second_name.' '.$last_name;
                $attribute['customer_visit_id']=$visit_data[1];
