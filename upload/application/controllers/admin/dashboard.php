...
class Dashboard extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['yearly_payment_report'] = $this->get_yearly_payment_report($data['year']);
  ...
  /*** Get Yearly Report ***/
    public function get_yearly_payment_report($year)
    {
        ...
        for ($i = 1; $i <= 12; $i++) {
            ...
            $get_all_report[$i] = $this->dashboard_model->get_yearly_payments_by_date($start_date, $end_date);
