                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                     <select id="customer" style="width: 100%;" name="customer" onchange="getPatient(this)">
                        <option value="">Select Patient Visit</option>
                        <?php  //$customer = $this->db->get('tbl_customer')->result(); 
                       			 $customer = $this->db->get('tbl_customer_visit')->result();
                        ?>
                        <?php if (!empty($customer)): ?>
                            <?php foreach ($customer as $item) : ?>
                                <option value="<?php echo $item->customer_id.','.$item->customer_visit_id; ?>" <?php echo $this->session->userdata('customer_id') == $item->customer_id ?'selected':'' ?>>
