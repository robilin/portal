            ...
            <div class="box box-primary">
               ...
               ?></b></h3>
                ...
                <form role="form" enctype="multipart/form-data" id="addcollateralForm" onsubmit="return imageForm(this)"
                      action="<?php echo base_url(); ?>admin/loan/save_collateral/<?php  if (!empty($collateral_info)) {
                                ...
                                <div class="tab-pane <?php if(empty($tab)){ echo 'active';} ?>" id="general">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="collateral_category_id" class="form-control col-sm-5" id="category" onchange="get_category(this.value)">
                                                <option value="">Select collateral Category</option>
                                                <?php if (!empty($category)): ?>
                                                    <?php foreach ($category as $v_category) : ?>
                                                        <option value="<?php echo $v_category->collateral_category_id; ?>"
                                                            <?php
                                                            if (!empty($collateral_info)) {
                                                                echo $v_category->collateral_category_id == $v_category->collateral_category_id ? 'selected' : '';
                                                            }
                                                            ?> >
                    ...
                    <div class="box-footer">
                        <button type="submit"  id="submit" class="btn bg-navy btn-flat col-md-offset-3" type="submit">Save Collateral
                        </button>
                    </div>
