                  ...
                  <tbody>
                     ...
                     <tr class="custom-tr">
                        ...
                        <td class="vertical-td">
                           ...
                           <?php } else { ?>
                           <span class="label bg bg-olive"><?php echo 'Fully Paid' ?></span>
                           <?php } ?>
                        </td>
                        <td class="vertical-td">
                           <div class="btn-group">
                        ...
                        <div class="box-body">
                           ...
                           <table id="datatable" class="table table-striped table-bordered datatable-buttons">
                              ...
                              <tbody>
                                 <!-- / Table body -->
                                 <?php   
                                    $loan_repayment = $this->db->get_where('tbl_loan_repayment',array('loan_loan_id'=>$v_loan->loan_id))->result();
                                      	?>
                                 <?php $counter =1 ; ?>
                           ...
                           <div class="row">
                              <div class="col-md-12">
                                <?php  
								 ...
								 $total_repayment = $this->db->get_where('tbl_loan_repayment',array('loan_loan_id'=>$v_loan->loan_id))->result();
