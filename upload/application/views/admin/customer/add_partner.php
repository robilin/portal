      ...
      <div class="col-md-12">
         <div class="box box-primary">
            <div class="box-header box-header-background with-border">
               <h3 class="box-title ">UPDATE/ADD PARTNER PROFILE ACCOUNT # <?php if(!empty($customer_info)){
                                          echo $customer_info->customer_account;
                                          }else {echo $code; } ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" enctype="multipart/form-data" id="addcustomerForm"	onsubmit="return imageForm(this)"	action="<?php echo base_url(); ?>admin/customer/save_partner/<?php  if (!empty($customer_info)) {
               ...
               <div class="row">
                  <div class="col-md-6 col-sm-8 col-xs-12 col-md-offset-3">
                     ...
                     <div class="form-group">
                        ...
                        <!-- landlord selection pane rmoved-->
