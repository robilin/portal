			   ...
			   <div class="box-header box-header-background with-border">
                ...
                <div class="box-body">
                    ...
                    <table id="datatable" class="table table-striped table-bordered datatable-buttons">
                            ...
                            <tbody><!-- / Table body -->
                            <?php   
                  			 $loan_info =$this->db->get_where('tbl_loan',array('approval'=>0))->result();
                        	?>
                            <?php $counter =1 ; ?>
                                    ...
                                    <td class="vertical-td">
                                        <div class="btn-group">
                                            <a href="<?php echo base_url().'admin/loan/edit_loan/'. $v_loan->loan_id ?>" class="btn btn-xs btn-default" ><i class="fa fa-pencil"></i></a>
                                             <a href="<?php echo base_url().'admin/loan/view_pending_loan/'. $v_loan->loan_id ?>" class="btn btn-xs btn-default" ><i class="fa fa-search"></i></a>               
                                        </div>
                                    </td>
