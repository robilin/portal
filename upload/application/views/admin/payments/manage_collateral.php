...
<section class="content">
    <div class="row">
        <form action="<?php echo base_url() ?>admin/loan/collateral_action" method="post">
        <div class="col-md-12">
                   ...
                   <!-- <table id="datatable" class="table table-striped table-bordered datatable-buttons"> -->
                    <table class="table table-bordered table-hover" id="dataTables-example">
                            ...
                            <tr>
                                ...
                                <th class="active">Collateral With</th>
                                ...
                                <tr class="custom-tr">
                                   ...
                                   <td class="product-img">
                                    ...
                                    <td class="vertical-td highlight">
                                        <a href="<?php echo base_url().'admin/loan/view_collateral/'. $v_collateral->collateral_id ?>"  data-toggle="modal" data-target="#myModal" >
                                            <?php echo $v_collateral->collateral_id ?>
                                        </a>
                                    </td>
                                    <td class="vertical-td"><?php echo $v_collateral->collateral_category_id ?></td>
                                    ...
                                    <td class="vertical-td"><?php echo $v_collateral->collateral_assigned_to ?></td>	
                                    ...
                                    <td class="vertical-td">
                                        ...
                                        <div class="btn-group">
                                       	    <a href="<?php echo base_url().'admin/loan/collateral_assign/'. $v_collateral->collateral_id ?>" class="btn btn-xs bg-olive" data-toggle="modal" data-target="#myModal"><i class="fa fa-book">Assign</i></a>
                                            <a href="<?php echo base_url().'admin/loan/add_collateral/'. $v_collateral->collateral_id ?>" class="btn btn-xs btn-default" ><i class="fa fa-pencil"></i></a>
                                            <a href="<?php echo base_url().'admin/loan/view_collateral/'. $v_collateral->collateral_id ?>" class="btn btn-xs bg-olive" data-toggle="modal" data-target="#myModal" ><i class="glyphicon glyphicon-search"></i></a>
                                            <a href="<?php echo base_url().'admin/loan/delete_collateral/'. $v_collateral->collateral_id ?>" class="btn btn-xs btn-danger" ><i class="glyphicon glyphicon-trash"></i></a>
                                        </div>
                                    </td>
